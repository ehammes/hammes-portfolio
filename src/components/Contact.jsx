            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              <div className='mt-1'>
                <input
                  ...
                  name='user_name'
                  maxLength={35}
                  className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-100 md:text-sm md:leading-6 pl-3 mb-4'
                />
              </div>
              <label className='block font-medium leading-6 text-gray-900'>
                Email
              ...
              <div className='mt-1'>
                <textarea
                  ...
                  name='message'
                  rows={3}
                  className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-100 md:text-sm md:leading-6 pl-3 overflow-auto mb-4'
                />
              </div>
