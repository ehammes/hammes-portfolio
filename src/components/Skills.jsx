  ...
  return (
    <div className='grid grid-cols-2 pt-2 md:grid-cols-4'>
      ...
      <div className='py-5 text-center'>
        ...
        <div className='pt-2 text-xs'>JAVASCRIPT</div>
      </div>
      
      {/* REACT */}
      <div className='py-5 text-center'>
        <FaReact size={50} style={{ color: '#61DBFB' }} className='mx-auto' />
        <div className='pt-2 text-xs'>REACT</div>
      </div>
      ...
      <div className='py-5 text-center'>
        ...
        <div className='pt-2 text-xs'>HTML</div>
      </div>
      ...
      <div className='py-5 text-center'>
        ...
        <div className='pt-2 text-xs'>CSS</div>
      </div>
      ...
      <div className='py-5 text-center'>
        ...
        <div className='pt-2 text-xs'>NEXT.JS</div>
      </div>
      ...
      <div className='py-5 text-center'>
        ...
        <div className='pt-2 text-xs'>TAILWINDCSS</div>
      </div>
      ...
      <div className='py-5 text-center'>
        ...
        <div className='pt-2 text-xs'>TYPESCRIPT</div>
      </div>
      ...
      <div className='py-5 text-center'>
        ...
        <div className='pt-2 text-xs'>NODE.JS</div>
      </div>
      ...
      <div className='py-5 text-center'>
        ...
        <div className='pt-2 text-xs'>MONGODB</div>
      </div>
      ...
      <div className='py-5 text-center'>
        ...
        <div className='pt-2 text-xs'>POSTGRESQL</div>
      </div>
      ...
      <div className='py-5 text-center'>
        ...
        <div className='pt-2 text-xs'>HEROKU</div>
      </div>
      ...
      <div className='py-5 text-center'>
        ...
        <div className='pt-2 text-xs'>JIRA</div>
      </div>
    </div>
  );
};
